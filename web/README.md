...
```
Sayt: `http://localhost:3535`  (server `0.0.0.0:3535` da tinglaydi)
...
|---|---|
| `PORT` | Server porti (standart 3535) |
| `HOST` | Tinglash manzili (standart 0.0.0.0) |
| `SITE_URL` | To'liq domen (canonical/hreflang uchun) |
| `LOGIN_URL` | CRM/login manzili (standart `https://ipak.elektronbozor.uz`) |
